        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
            {[
              ...
              { label: 'En cours',  value: stats.en_cours, color: '#1890ff',          icon: <ClockCircleOutlined style={{ color: '#1890ff' }} />         },
            ...
            {applications.length === 0 && !loading ? (
              ...
              <>
                <List
                  ...
                  renderItem={(app) => {
                    const status = STATUS_CONFIG[app.statut] ?? STATUS_CONFIG.en_cours;
                    return (
                      <List.Item

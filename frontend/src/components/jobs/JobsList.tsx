...
import DOMPurify from 'dompurify'; // Import indispensable
        ...
        <Row gutter={[24, 24]}>
          {filteredJobs.map((job) => (
            <Col xs={24} sm={12} lg={8} key={job.id}>
              <Card
              data-testid="job-card" // 👈 INDISPENSABLE pour Cypress
                hoverable
                style={{
                  height: '100%',
                  borderRadius: 12,
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: 12 }}>
                  <div style={{
                    width: 48, height: 48, borderRadius: 12, background: '#e6f7f5',
                ...
                {/* CORRECTION : Affichage du HTML avec limitation de lignes */}
                <div 
                  ...
                  style={{ 
                    ...
                    marginBottom: 16, 
                    flex: 1,
                    minHeight: '60px' // Pour aligner les boutons
                  }}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto' }}>
                  ...
                  <Link to={`/jobs/${job.id}`}>
                    <Button type="primary" size="small" style={{ borderRadius: 6 }} data-testid="view-job-button">
                      Voir l'offre
                    </Button>
                  </Link>
                </div>

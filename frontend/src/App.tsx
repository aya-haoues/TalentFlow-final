...
import StatistiquesPage from './pages/rh/StatistiquesPage';
...
import AgendaPage       from './pages/rh/AgendaPage';
import RhProfile      from './pages/rh/RhProfile';
...
<Route path="/rh/statistiques"      element={<RhRoute><StatistiquesPage /></RhRoute>} />

<Route path="/rh/agenda"                  element={<RhRoute><AgendaPage /></RhRoute>} />

<Route path="/rh"></Route>

<Route path="/rh/profile" element={<RhProfile />} />

// Le ":" signifie que "tab" est une variable
<Route path="/rh/settings/:tab" element={<RhSettings />} />
// Garde aussi la route de base pour l'onglet par défaut
